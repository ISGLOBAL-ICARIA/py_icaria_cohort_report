...
if __name__ == '__main__':
    ...
    for project_key in params.TRIAL_PROJECTS:
        ...
        if project_key.split(".")[0] in cohort_list_df['HF'].unique():
            ...
            summary_sheet_part = cohorts.excel_creation(project_key=project_key,redcap_project=project,redcap_project_df=df,excelwriter=writer,summarywriter= writer_summary)
