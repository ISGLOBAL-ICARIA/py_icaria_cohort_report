...
def cohort_stopping_sistem(redcap_project,nletter,projectkey,date_='2023-03'):
    """
...
def summary_excel_creation(project_key,redcap_project_df,summarywriter,all_to_FW,summary,stop):
    summary_sheet = pd.DataFrame(index=[project_key],columns=['A-elegible','A-recruited','B-elegible','B-recruited',
        'C-elegible','C-recruited','D-elegible','D-recruited','E-elegible','E-recruited','F-elegible','F-recruited',])
    list_to_summary = []
